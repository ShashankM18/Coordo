...
export const inviteAPI = {
  create: (data) => api.post('/invite', data),
  getMyInvites: () => api.get('/invite/my-invites'),
  accept: (inviteId) => api.post('/invite/accept-invite', { inviteId }),
  reject: (inviteId) => api.post('/invite/reject-invite', { inviteId }),
};
